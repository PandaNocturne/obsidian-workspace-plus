...
var SESSION_EDIT_STRINGS = {
    ...
    ja: {
        ...
        groupDefault: 'デフォルト',
        groupMovedToDefault: function (n) { return '"' + n + '" をデフォルトに移動しました'; },
        ...
        historyManualSaved: function (t) { return 'スナップショット "' + t + '" を保存しました'; },
        historyEditEntry: '編集',
        historyEditEntryTitle: '履歴を編集',
        historyUpdateLayoutFromCurrent: '現在のワークスペースでレイアウトを更新',
        historyEntryRenamed: function (t) { return '"' + t + '" に改名しました'; },
        historyEntryUpdated: function (t) { return t ? '"' + t + '" を更新しました' : '履歴を更新しました'; },
        historyEntryDeleted: function (t) { return '"' + t + '" を削除しました'; },
        historyDeleteConfirm: function (t) { return '履歴 "' + t + '" を削除しますか？'; },
        historyUntitled: '無題',
        archive: 'ゴミ箱',
        archiveArea: 'ゴミ箱',
        archiveEmpty: 'ゴミ箱は空です。',
        archived: function (n) { return '"' + n + '" をゴミ箱に移動しました'; },
        confirmDeleteOrArchive: function (n) { return '"' + n + '" をゴミ箱に移しますか、それとも完全に削除しますか？'; },
        restoreFromArchive: '復元',
        restoredFromArchive: function (n) { return '"' + n + '" をゴミ箱から復元しました'; },
...
var TAB_SWITCHER_STRINGS = {
    ...
    ja: {
        ...
        tabSwitcherHint: 'プレビューをクリックで切り替え · ヘッダーをドラッグで並べ替え · 外側クリックで取消',
        tabSwitcherHintNav: 'マスクをスクロールでペイン切替 · 数字キーでペイン切替 · ページをダブルクリックでフォーカス',
        tabSwitcherHintGrid: 'プレビューをクリックで切り替え · ヘッダーをドラッグで並べ替え · 外側クリックで取消',
        tabSwitcherHintSplit: 'スクロール / 数字でペイン切替',
        tabSwitcherPrevSplit: '前のペイン',
        tabSwitcherNextSplit: '次のペイン',
        tabSwitcherSplitLabel: function (i, n) { return 'ペイン ' + i + ' / ' + n; },
        ...
        settingsShowTaskViewHints: 'タスクビューのヒントを表示',
        settingsShowTaskViewHintsDesc: 'ペインナビまたはグリッドにホバーしたとき操作ヒントを表示します。',
    },
    ko: {
        cmdTabSwitcher: '탭 전환 (미션 컨트롤)',
        tabSwitcherTitle: '탭 전환',
        tabSwitcherEmpty: '전환할 탭이 없습니다.',
        tabSwitcherHint: '미리보기 클릭으로 전환 · 헤더 드래그로 정렬 · 바깥 클릭으로 취소',
        tabSwitcherHintNav: '마스크 스크롤로 분할 전환 · 숫자 키로 분할 전환 · 페이지 더블클릭으로 집중',
        tabSwitcherHintGrid: '미리보기 클릭으로 전환 · 헤더 드래그로 정렬 · 바깥 클릭으로 취소',
        tabSwitcherHintSplit: '마스크 스크롤 / 숫자로 분할 전환',
        tabSwitcherPrevSplit: '이전 분할',
        tabSwitcherNextSplit: '다음 분할',
        tabSwitcherSplitLabel: function (i, n) { return '분할 ' + i + ' / ' + n; },
        ...
        settingsShowTaskViewHints: '작업 보기 힌트 표시',
        settingsShowTaskViewHintsDesc: '분할 탐색 또는 그리드에 마우스를 올리면 사용 힌트를 표시합니다.',
    },
};
