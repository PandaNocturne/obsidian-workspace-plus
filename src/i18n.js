...
var TAB_SWITCHER_STRINGS = {
    en: {
        ...
        tabSwitcherHintNav: 'Click preview to switch · Drag header to reorder · Double-click page for focus · Click outside to cancel',
        tabSwitcherHintGrid: 'Scroll to switch split · Number keys to switch split',
    ...
    zh: {
        ...
        tabSwitcherHintNav: '点击预览切换 · 拖动头部排序 · 双击页码进入专注 · 点击外部取消',
        tabSwitcherHintGrid: '滚轮切换分栏 · 数字键切换分栏',
    ...
    'zh-TW': {
        ...
        tabSwitcherHintNav: '點擊預覽切換 · 拖曳標題列排序 · 雙擊頁碼進入專注 · 點擊外部取消',
        tabSwitcherHintGrid: '滾輪切換分欄 · 數字鍵切換分欄',
    ...
    ja: {
        ...
        tabSwitcherHintNav: 'プレビューをクリックで切り替え · ヘッダーをドラッグで並べ替え · ページをダブルクリックでフォーカス · 外側クリックで取消',
        tabSwitcherHintGrid: 'スクロールでペイン切替 · 数字キーでペイン切替',
        ...
        settingsShowTaskViewHintsDesc: 'ペインナビとグリッド下に操作ヒントを表示します。',
    },
    ko: {
        ...
        tabSwitcherHintNav: '미리보기 클릭으로 전환 · 헤더 드래그로 정렬 · 페이지 더블클릭으로 집중 · 바깥 클릭으로 취소',
        tabSwitcherHintGrid: '스크롤로 분할 전환 · 숫자 키로 분할 전환',
        ...
        settingsShowTaskViewHintsDesc: '분할 탐색과 그리드 아래에 사용 힌트를 표시합니다.',
    },
};
