...
var TAB_SWITCHER_STRINGS = {
    en: {
        ...
        tabSwitcherHint: 'Click preview to switch · Drag header to reorder · Scroll mask for split · Click outside to cancel',
        tabSwitcherHintSplit: '‹ › or 1–9 to switch split · Drop on grid to move across',
    ...
    zh: {
        ...
        tabSwitcherHint: '点击预览切换 · 拖动头部排序 · 蒙版滚轮切分栏 · 点击外部取消',
        tabSwitcherHintSplit: '‹ › 或数字键切换分栏 · 拖到目标分栏网格中松开以跨栏移动',
    ...
    'zh-TW': {
        ...
        tabSwitcherHintSplit: '‹ › 或數字鍵切換分欄 · 拖到目標分欄網格鬆開以跨欄移動',
    ...
    ja: {
        ...
        tabSwitcherHintSplit: '‹ › または数字でペイン切替 · グリッドへドロップで移動',
    ...
    ko: {
        ...
        tabSwitcherHintSplit: '‹ › 또는 숫자로 분할 전환 · 그리드에 놓아 이동',
