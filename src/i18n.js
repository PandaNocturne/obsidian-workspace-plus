...
var TAB_SWITCHER_STRINGS = {
    en: {
        ...
        tabSwitcherHintNav: 'Click preview to switch · Drag header to reorder · Click outside to cancel',
        tabSwitcherHintGrid: 'Scroll mask to switch split · Number keys to switch split',
    ...
    zh: {
        ...
        tabSwitcherHintNav: '点击预览切换 · 拖动头部排序 · 点击外部取消',
        tabSwitcherHintGrid: '蒙版滚轮切分栏 · 数字键切换分栏',
    ...
    'zh-TW': {
        ...
        tabSwitcherHintNav: '點擊預覽切換 · 拖曳標題列排序 · 點擊外部取消',
        tabSwitcherHintGrid: '蒙版滾輪切分欄 · 數字鍵切換分欄',
    ...
    ja: {
        ...
        tabSwitcherHintNav: 'プレビューをクリックで切り替え · ヘッダーをドラッグで並べ替え · 外側クリックで取消',
        tabSwitcherHintGrid: 'マスクをスクロールでペイン切替 · 数字キーでペイン切替',
    ...
    ko: {
        ...
        tabSwitcherHintNav: '미리보기 클릭으로 전환 · 헤더 드래그로 정렬 · 바깥 클릭으로 취소',
        tabSwitcherHintGrid: '마스크 스크롤로 분할 전환 · 숫자 키로 분할 전환',
